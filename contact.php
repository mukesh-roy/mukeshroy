<?php require_once 'send-contact-details.php'; ?>
        ...
        <div class="description">
            <h1>&lt;Contact info&gt;</h1>
                ...
                <div class="large-6 column collapse">
                    <form method="post" action="send-contact-details.php"  enctype="multipart/form-data" data-abide>
                    <fieldset>
                        ...
                        <label for="purpose" class="hide">Optional Attachment(Only Doc File)
